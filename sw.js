const CACHE_NAME = 'textes-quiz-v5';
const APP_SHELL = [
  './', './index.html', './style.css?v=5', './app.js?v=5', './config.js', './data-store.js',
  './supabase-adapter.js', './word-export.js', './adaptive-engine.js', './analytics-engine.js', './speech-reader.js?v=5',
