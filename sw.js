const CACHE_NAME = 'textes-quiz-v6';
const APP_SHELL = [
  './', './index.html', './style.css?v=6', './app.js?v=6', './config.js', './data-store.js',
  './supabase-adapter.js', './word-export.js', './adaptive-engine.js', './analytics-engine.js', './speech-reader.js?v=6',
