const CACHE_NAME = 'textes-quiz-v14';
const APP_SHELL = [
  './', './index.html', './style.css?v=14', './app.js?v=14', './config.js', './data-store.js',
...
const DATA_PATTERN = /\/(?:bible|history-france|humanities|learning|quran-[1-6])\.json$/;
