...
assert.deepEqual(snapshot.history.histoire, []);
...
delete legacySnapshot.history.histoire; delete legacySnapshot.progress.histoire; delete legacySnapshot.favorites.histoire;
QuizData.importSnapshot(legacySnapshot);
QuizData.setCorpus('histoire');
assert.deepEqual(QuizData.getHistory(), []);
assert.deepEqual(QuizData.getProgress({}), {});
assert.deepEqual(QuizData.getFavorites(), []);
